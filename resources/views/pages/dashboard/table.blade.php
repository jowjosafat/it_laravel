...
@section('title', 'IT Table')

@section('tablelogin', 'active')

@section('contenlogin')

<div class="content col-sm-12">
  <div class="card-header mb-3">
    <h5 class="title">Tiketing Troubleshoot IT</h5>
    <div class="row">
      <div class="col">
        <p class="category">Problem | Purchase Requistion | Success Troubleshoot</p>
      </div>
      <div class="col-8">
